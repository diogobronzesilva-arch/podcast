...
<footer class="site-footer">
	...
	<div class="content-shell content-shell--wide site-footer__legal">
		<p>&copy; <?php echo esc_html( wp_date( 'Y' ) ); ?> Bronze Podcast · <a href="https://tesourofieis.com" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Oração', 'bronzepodcast' ); ?></a></p>
	</div>
</footer>
<?php wp_footer(); ?>
</body>
