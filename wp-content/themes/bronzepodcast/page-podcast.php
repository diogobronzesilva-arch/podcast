			...
			<div class="podcast-featured__card">
				...
				<div class="podcast-featured__info">
					...
					<div class="podcast-featured__actions">
						<a class="button button--accent" href="<?php echo esc_url( $featured_episode['youtube'] ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Ver no YouTube', 'bronzepodcast' ); ?> <span aria-hidden="true">↗</span></a>
						<a class="button button--outline" href="<?php echo esc_url( $featured_episode['spotify'] ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Ouvir no Spotify', 'bronzepodcast' ); ?> <span aria-hidden="true">↗</span></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="podcast-grid">
				<?php foreach ( $curated_episodes as $episode ) : ?>
					<article class="podcast-card">
						<div class="podcast-card__thumb-wrap">
						...
						<div class="podcast-card__content">
							...
							<h3 class="podcast-card__title"><?php echo esc_html( $episode['title'] ); ?></h3>
							...
							<div class="podcast-card__links">
								<a class="text-link" href="<?php echo esc_url( $episode['youtube'] ); ?>" target="_blank" rel="noopener noreferrer">
									<?php esc_html_e( 'Ver no YouTube', 'bronzepodcast' ); ?> <span>↗</span>
								</a>
								<a class="text-link" href="<?php echo esc_url( $episode['spotify'] ); ?>" target="_blank" rel="noopener noreferrer">
									<?php esc_html_e( 'Ouvir no Spotify', 'bronzepodcast' ); ?> <span>↗</span>
								</a>
							</div>
						</div>
					</article>
