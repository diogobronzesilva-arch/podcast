# Voz e copy do Bronze Podcast

## Diagnóstico

O copy da versão 0.3.0 estava demasiado próximo de uma linguagem de marca genérica: frases curtas, elegantes e abstractas que poderiam pertencer a muitos projectos. O Bronze Podcast tem uma voz mais pessoal, concreta e comprometida.
...
2. **Nomear as coisas.** Dizer Fé Católica Tradicional, Igreja, Portugal, família, Nação, oração e combate espiritual em vez de conceitos vagos como propósito, essência ou comunidade.
3. **Ser directo.** Títulos claros têm prioridade sobre slogans publicitários.
4. **Usar perguntas com intenção.** As perguntas devem obrigar a pensar, não servir apenas como decoração.
...
Apresentar imediatamente o projecto na primeira pessoa, explicar que nasceu em 2020 para divulgar a Fé Católica Tradicional e dar prioridade aos últimos episódios. A loja deve ser apresentada de forma concreta, sem romantizar os produtos.

### Sobre

Conservar o manifesto original. O cabeçalho deve introduzir o texto com o objectivo real do Podcast, sem inventar uma promessa de marketing.
...
Explicar o que se vende e por que razão foi escolhido. Evitar atribuir simbolismo genérico a todos os produtos.

### Contacto

Usar primeira pessoa e um convite simples: “Escreva-me.”

### Newsletter

Prometer apenas o que será cumprido: notícias de episódios, artigos e loja quando houver algo para partilhar.

## Regra editorial

Antes de publicar um novo texto, perguntar: “Diogo diria isto desta forma numa conversa ou num artigo?” Se a frase parecer escrita por uma agência, deve ser simplificada ou substituída por algo mais concreto.
